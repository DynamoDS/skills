...
<section style="padding-top: 32px;">
  <div style="margin-bottom: 24px;">
    ...
    <div class="tab-panel" id="tab-ghcli">
      ...
      <p class="setup-note" style="margin-top:8px;"><a href="https://github.blog/changelog/2026-04-16-manage-agent-skills-with-github-cli/" target="_blank" rel="noopener" style="color:var(--accent);">GitHub CLI skills documentation ↗</a></p>
    </div>
